...
//The origin of basic rectangles is assumed to at the top left
...
struct RectangleData
{
    ...
    RectangleData* reference_rectangle_data = nullptr;
    ...
    RectangleData();
    RectangleData(RectangleData* param_reference_rectangle_data);
    ...
    Point2D GetUniScaledOffset();
    double GetUniScaledXOffset();
    double GetUniScaledYOffset();
    ...
    Point2D GetScaledOffset();
    double GetScaledXOffset();
    double GetScaledYOffset();
    ...
    double GetScaledEdge(Direction direction);
    //Changes offset
    ...
    double GetUniEdge(Direction direction);
    //Changes pos
    ...
    Size2D GetUniSizeScale();
    double GetUniWidthScale();
    double GetUniHeightScale();
    ...
    Point2D GetUniPointFromScaledPoint(Point2D param_scaled_point);
    double GetUniXFromScaledX(double param_scaled_x);
    double GetUniYFromScaledY(double param_scaled_y);
    ...
    BasicRectangle GetBasicRectangle();

    RectStructOne GetRectStructOne();
};
