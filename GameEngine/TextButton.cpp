...
void SimpleTextButton::InitMost(RectangleOld param_parent_rect, TextBox param_text_box, double param_scaled_border_width, double param_scaled_drop_amount, const ButtonSoundData param_sounds)
{
